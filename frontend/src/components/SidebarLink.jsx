...
export default function SidebarLink({ path, name, icon }) {
	...
	const navClass =
		'navIconContainer transition-all md:w-full sm:p-2 rounded-md md:pl-4 md:py-3 md:pr-10 flex flex-col sm:flex-row sm:gap-2 items-center justify-start md:w-[10rem] text-muted-foreground hover:text-primary/90 font-medium';
